...
function mapDbPropertyToProperty(dbProperty: any): Property {
  return {
    ...
    plotNumber: dbProperty.plot_number,
    ...
    squareFeet: dbProperty.square_feet || 0,
    monthlyRent: Number(dbProperty.monthly_rent) || 0,
    status: dbProperty.status || 'vacant',
    imageUrl: dbProperty.image_url,
    description: dbProperty.description,
    amenities: dbProperty.amenities || [],
    isFurnished: dbProperty.is_furnished,
    isFitForHabitation: dbProperty.is_fit_for_habitation !== false
  };
}
...
function mapDbTenantToTenant(dbTenant: any): Tenant {
  return {
    ...
    idNumber: dbTenant.id_number,
    idType: dbTenant.id_type,
    ...
    monthlyRent: Number(dbTenant.monthly_rent) || 0,
    securityDeposit: Number(dbTenant.security_deposit) || 0,
    rentInAdvance: dbTenant.rent_in_advance,
    status: dbTenant.status || 'pending',
    emergencyContact: {
